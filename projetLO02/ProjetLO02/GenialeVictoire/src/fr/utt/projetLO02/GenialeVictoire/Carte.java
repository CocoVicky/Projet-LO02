...
/**
 * Permet d'avoir la valeur entière d'une carte.
 * @param value
 * @return l'entier correspondant à chaque carte.
 */
...
public void setSuit(Famille suit) {
	...
	/**
	 * Permet d'avoir une copie d'une carte sur laquelle on pourra agir sans impact sur la carte originale.
	 * @return la copie de la carte.
	 */
